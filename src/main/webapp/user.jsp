...
<header>
<div align="right">
    <p style="display:inline-block;">${user.lastName} ${user.firstName} ${user.patronymic}</p>
    <form style="display:inline-block;" action="/servlet?action=exit" method="post">
        ...
        <td valign="top">
            <main>
                <div class="menu" align="center">
                    ...
                    <div>
                        <form class="formForEdit" action="/servlet?action=edit" method="post" onsubmit="return false;">
                            <table id="edit">
                                <tr>
